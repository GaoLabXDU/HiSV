...
if __name__ == '__main__':
    ...
    parser = OptionParser()
    parser.add_option('-f', '--hicfile', default='/media/li/Data/K562/5kb/inter/', help='path of hic matrix file (chr*_chr*.txt)')
    parser.add_option('-b', '--binsize', type='int', default=5000)
    parser.add_option('-i', '--input',  default='/home/li/PycharmProjects/HiSV/k562_inter_combine_score.txt', help="path of result file from HiSV")
    parser.add_option('-p', '--position',  default='inter', help="intra/inter")
    parser.add_option('-o', '--output', default='/media/li/Data/K562/50Kb/result', help='path of breakpoint file')
