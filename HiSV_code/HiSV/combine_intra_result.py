...
'''
binsize = 100000
filename = "/media/li/Data/HCC1954/hic_breakfinder_result/different_ratio_result/intra/HCC1954_ratio_10_result.txt"
chr1, chr2, pos1, pos2 = read_filter_file(filename)
group_chr = list(group(chr1))
intra_result_file = "/media/li/Data/HCC1954/hic_breakfinder_result/different_ratio_result/intra/HCC1954_ratio_10_combine_result.txt"
for i in range(len(group_chr)):
    pos1list = pos1[group_chr[i][0]:group_chr[i][1] + 1]
    pos2list = pos2[group_chr[i][0]:group_chr[i][1] + 1]
    print(chr1[group_chr[i][0]])
